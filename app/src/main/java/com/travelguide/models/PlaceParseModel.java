...
public class PlaceParseModel extends ParseObject {
    ...
    public Integer getVisitingTime() {return getInt("placeVisitingTime");}
    ...
    public void putVisitingTime(Integer placeVisitingTime) {put("placeVisitingTime",placeVisitingTime);}
